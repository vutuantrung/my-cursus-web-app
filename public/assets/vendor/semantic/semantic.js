                ...
                get: {
                    ...
                    prompt: function (rule, field) {
                        ...
                        if (requiresName) {
                            ...
                            name =
                                $label.length == 1 ? $label.text() : $field.prop('placeholder') || settings.text.unspecifiedField;
            ...
            module = {
                    ...
                    menu: {
                        mutation: function (mutations) {
                            var mutation = mutations[0],
                                ...
                                isMessage =
                                    $changedNodes.is(selector.message) || $changedNodes.closest(selector.message).length > 0;
                ...
                has: {
                    ...
                    label: function (value) {
                        ...
                        return (
                            $labels.filter('[data-' + metadata.value + '="' + module.escape.string(escapedValue) + '"]').length >
                            0
                        );
                    },
