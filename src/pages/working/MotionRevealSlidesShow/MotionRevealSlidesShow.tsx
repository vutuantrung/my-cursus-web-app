        ...
        if (docState === 'complete') {
            class Slide {
                ...
                constructor(el: any) {
                    this.DOM = { el: el };
                    // The image conteiner.
                    this.DOM.imgWrap = this.DOM.el.querySelector(`.${styles['slide__img-wrap']}`);
                    // The revealer element (the element with the same color of the body that covers the image).
                    this.DOM.revealer = this.DOM.imgWrap.querySelector(`.${styles['slide__img-reveal']}`);
                    // The title element.
                    this.DOM.title = this.DOM.el.querySelector(`.${styles['slide__title']}`);
                    // The slide´s number element
                    this.DOM.number = this.DOM.el.querySelector(`${styles['slide__number']}`);
                    // The large preview elements (also an image and revealer for the cover/uncover effect)
                    this.DOM.preview = {
                        imgWrap: this.DOM.el.querySelector(`.${styles['preview__img-wrap']}`),
                        revealer: this.DOM.el.querySelector(`.${styles['preview__img-wrap']} > .${styles['preview__img-reveal']}`),
                        title: this.DOM.el.querySelector(`.${styles['preview__title']}`),
                        content: this.DOM.el.querySelector(`.${styles['preview__content']}`),
                    };
                ...
                setCurrent(isCurrent = true) {
                    this.DOM.el.classList[isCurrent ? 'add' : 'remove'](styles['slide--current']);
                }
                // Hide the slide.
                hide(direction: any) {
            ...
            class Slideshow {
                ...
                constructor(el: any) {
                    ...
                    this.DOM.prevCtrl = this.DOM.el.querySelector(`.${styles['slidenav__item--prev']}`);
                    this.DOM.nextCtrl = this.DOM.el.querySelector(`.${styles['slidenav__item--next']}`);
                    this.DOM.previewCtrl = this.DOM.el.querySelector(`.${styles['slidenav__preview']}`);
                    // The slides.
                    this.slides = [];
                    Array.from(this.DOM.el.querySelectorAll(`.${styles['slide']}`)).forEach((slideEl) => this.slides.push(new Slide(slideEl)));
            ...
            imagesLoaded(
                document.querySelectorAll(`.${styles['slide__img']}
                .${styles['preview__img']}`),
                { background: true },
                () => {
                    ...
                    <main className={styles['main_div']}>
                        ...
                        <div className={styles['slideshow']}>
                            <div className={styles['slide']}>
                                <div className={styles['preview']}>
                                    <div className={styles['preview__img-wrap']}>
                                        <div className={`${styles['preview__img']} ${styles['preview__img_0']}`}></div>
                                ...
                                <div className={styles['slide__img-wrap']}>
                                    <div className={`${styles['slide__img']} ${styles['slide__img_0']}`}></div>{' '}
                            ...
                            <div className={styles['slide']}>
                                <div className={styles['preview']}>
                                    <div className={styles['preview__img-wrap']}>
                                        <div className={`${styles['preview__img']} ${styles['preview__img_1']}`}></div>
                                        <div className={styles['preview__img-reveal']}></div>
                                    </div>
                                ...
                                <div className={styles['slide__img-wrap']}>
                                    <div className={`${styles['slide__img']} ${styles['slide__img_1']}`}></div>{' '}
                                    <div className={styles['slide__img-reveal']}></div>
                                </div>
                            ...
                            <div className={styles['slide']}>
                                <div className={styles['preview']}>
                                    <div className={styles['preview__img-wrap']}>
                                        <div className={`${styles['preview__img']} ${styles['preview__img_2']}`}></div>
                                        <div className={styles['preview__img-reveal']}></div>
                                    </div>
                                ...
                                <div className={styles['slide__img-wrap']}>
                                    <div className={`${styles['slide__img']} ${styles['slide__img_2']}`}></div>{' '}
                                    <div className={styles['slide__img-reveal']}></div>
                                </div>
                            ...
                            <div className={styles['slide']}>
                                <div className={styles['preview']}>
                                    <div className={styles['preview__img-wrap']}>
                                        <div className={`${styles['preview__img']} ${styles['preview__img_3']}`}></div>
                                        <div className={styles['preview__img-reveal']}></div>
                                    </div>
                                ...
                                <div className={styles['slide__img-wrap']}>
                                    <div className={`${styles['slide__img']} ${styles['slide__img_3']}`}></div>
                                    <div className={styles['slide__img-reveal']}></div>
                                </div>
                            ...
                            <div className={styles['slide']}>
                                <div className={styles['preview']}>
                                    <div className={styles['preview__img-wrap']}>
                                        <div className={`${styles['preview__img']} ${styles['preview__img_4']}`}></div>
                                        <div className={styles['preview__img-reveal']}></div>
                                    </div>
                                ...
                                <div className={styles['slide__img-wrap']}>
                                    <div className={`${styles['slide__img']} ${styles['slide__img_4']}`}></div>{' '}
                                    <div className={styles['slide__img-reveal']}></div>
                                </div>
