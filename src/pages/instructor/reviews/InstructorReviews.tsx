                                    ...
                                    <div className="col-lg-7">
                                        ...
                                        <div className="review_all120">
                                            ...
                                            <div className="review_item">
                                                ...
                                                <p className="rvds10">
                                                    Nam gravida elit a velit rutrum, eget dapibus ex elementum. Interdum et
                                                    malesuada fames ac ante ipsum primis in faucibus. Fusce lacinia, nunc sit amet
                                                    tincidunt venenatis.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="review_all120 mt-30">
                                            <div className="review_item_course_title">
                                                <a href="#">Course Title Here</a>
                                            </div>
                                            <div className="review_item">
                                        ...
                                        <div className="review_all120 mt-30">
                                            ...
                                            <div className="review_item">
                                                <div className="review_usr_dt">
                                                    ...
                                                    <div className="rv1458">
                                                        <h4 className="tutor_name1">Rock William</h4>
                                                        <span className="time_145">5 hour ago</span>
                                                    </div>
                                                </div>
                                                <div className="rating-box mt-20">
                                                    <span className="rating-star full-star"></span>
