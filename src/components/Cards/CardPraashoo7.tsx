...
import styles from './CardPraashoo7.module.css';
        ...
        <div className={styles['main']}>
            ...
            <div className={styles['data']}>
                <div className={styles['img']}>
                    <img src={IMAGES.avatar} className={styles['img']} alt="" />
                </div>
                <div className={styles['text']}>
                    <div className={styles['text_m']}>CSS Gradient Button</div>
                    <div className={styles['text_s']}>Praashoo7</div>
                </div>
            </div>
            <div className={styles['btns']}>
                <div className={styles['likes']}>
                    ...
                    <span className={styles['likes_text']}>22</span>
                </div>
                <div className={styles['comments']}>
                    <svg viewBox="-405.9 238 56.3 54.8" className={styles['comments_svg']}>
                ...
                <div className={styles['views']}>
                    <svg viewBox="0 0 30.5 16.5" className={styles['views_svg']}>
                    ...
                    <span className={styles['views_text']}>332</span>
                </div>
            </div>
        </div>
    );
