import styles from './CardSmitPrajapati3.module.css';

const CardSmitPrajapati3 = () => {
    return (
        <div className={styles['card']}>
            <div className={styles['background']}></div>
            <div className={styles['logo']}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29.667 31.69" className={styles['logo-svg']}>
                    <path
                        id="Path_6"
                        data-name="Path 6"
...
export default CardSmitPrajapati3;
