...
import styles from './CardSmitPrajapati.module.css';

const CardSmitPrajapati = () => {
    return (
        <div className={styles['card']}>
            <button className={styles['mail']}>
                <svg
                    ...
                    className={`${styles['lucide']} ${styles['lucide-mail']}`}
                >
            ...
            <div className={styles['bottom']}>
                <div className={styles['content']}>
                    ...
                    <span className={styles['about-me']}>Lorem ipsum dolor sit amet consectetur adipisicinFcls </span>
                </div>
...
export default CardSmitPrajapati;
