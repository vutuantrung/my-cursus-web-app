import styles from './CardAndrewDemchenk0.module.css';

const CardAndrewDemchenk0 = () => {
    return (
        <div className={styles['card']}>
            ...
            <div className={styles['card-socials']}>
                <button className={`${styles['card-socials-btn']} ${styles['facebook']}`}>
                    <svg
                ...
                <button className={`${styles['card-socials-btn']} ${styles['github']}`}>
                ...
                <button className={`${styles['card-socials-btn']} ${styles['linkedin']}`}>
...
export default CardAndrewDemchenk0;
